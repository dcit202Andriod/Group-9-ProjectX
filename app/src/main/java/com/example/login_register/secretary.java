...
public class secretary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("SRC Secretary");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled( DatabaseError error) {
                Toast.makeText(secretary.this, "Failed", Toast.LENGTH_SHORT).show();
        ...
        voteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(secretary.this, "Vote submitted", Toast.LENGTH_SHORT).show();
